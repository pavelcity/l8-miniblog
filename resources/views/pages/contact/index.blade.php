...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
			...
			<iframe class="absolute inset-0" style="filter: grayscale(1) contrast(1.2) opacity(0.4);" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://yandex.ru/map-widget/v1/?um=constructor%3Aaeb9e8527de1c059c7092246f452070094dc78ae76b9eed2b1494b4797b27668&amp;source=constructor" width="100%" height="100%" frameborder="0"></iframe>
    ...
    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p class="leading-relaxed mb-5 text-gray-600">Пишите или звоните</p>
